 ...
 */
final class Version20260104190022 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE creation_ticket ADD CONSTRAINT `FK_F9F775D6327D30B2` FOREIGN KEY (id_priority) REFERENCES priorities (priorite_id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE creation_ticket ADD CONSTRAINT `FK_F9F775D65697F554` FOREIGN KEY (id_category) REFERENCES category-post (id_category) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE creation_ticket ADD CONSTRAINT `FK_F9F775D65D37D0F1` FOREIGN KEY (id_status) REFERENCES statuts (status_id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE creation_ticket ADD CONSTRAINT `FK_F9F775D66B3CA4B` FOREIGN KEY (id_user) REFERENCES utilisateur (id_user) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE attachment DROP FOREIGN KEY FK_795FD9BB700047D2');
        $this->addSql('ALTER TABLE kb_article DROP FOREIGN KEY FK_AB480EA1F675F31B');
        $this->addSql('ALTER TABLE kb_article DROP FOREIGN KEY FK_AB480EA112469DE2');
